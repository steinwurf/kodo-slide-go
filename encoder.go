...
// type Encoder struct {
// 	mEncoder C.kodo_slide_encoder_t
// }
...
// 	C.kodo_slide_encoder_destruct(encoder.mEncoder)
// }
...
// 	return uint32(C.kodo_slide_encoder_payload_size(encoder.mEncoder))
// }
...
// 	return uint32(C.kodo_slide_encoder_write_payload(
...
// 	return uint32(C.kodo_slide_encoder_block_size(encoder.mEncoder))
// }
...
// 	return uint32(C.kodo_slide_encoder_symbol_size(encoder.mEncoder))
// }
...
// 	return uint32(C.kodo_slide_encoder_symbols(encoder.mEncoder))
// }
...
// 	C.kodo_slide_encoder_set_const_symbols(
