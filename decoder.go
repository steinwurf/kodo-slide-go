...
type Decoder struct {
	mDecoder C.kodo_slide_decoder_t
}
...
func freeDecoder(decoder *Decoder) {
	C.kodo_slide_decoder_destruct(decoder.mDecoder)
}
...
func (decoder *Decoder) PayloadSize() uint32 {
	return uint32(C.kodo_slide_decoder_payload_size(decoder.mDecoder))
}
...
func (decoder *Decoder) ReadPayload(payload *[]uint8) {
	C.kodo_slide_decoder_read_payload(
...
func (decoder *Decoder) BlockSize() uint32 {
	return uint32(C.kodo_slide_decoder_block_size(decoder.mDecoder))
}
...
func (decoder *Decoder) SymbolSize() uint32 {
	return uint32(C.kodo_slide_decoder_symbol_size(decoder.mDecoder))
}
...
func (decoder *Decoder) Symbols() uint32 {
	return uint32(C.kodo_slide_decoder_symbols(decoder.mDecoder))
}
...
func (decoder *Decoder) SetMutableSymbols(data *[]uint8) {
	C.kodo_slide_decoder_set_mutable_symbols(
...
func (decoder *Decoder) IsComplete() bool {
	return C.kodo_slide_decoder_is_complete(decoder.mDecoder) != 0
}
...
func (decoder *Decoder) Rank() uint32 {
	return uint32(C.kodo_slide_decoder_rank(decoder.mDecoder))
}
